...
- percutaneous gastrostomy
	...
	- warn the patient, then perform sequential dilation over the wire using stiff dilators followed by a peel-away sheath
		- peel-away should be 4Fr larger than the gastrostomy catheter — eg. a 16Fr catheter requires a 20Fr peel-away, or an 18Fr catheter requires a 22Fr peel-away
...
### postprocedure care
- if placed for <u>feeding</u> → gravity drainage/low intermittent wall suction and NPO for **24h** before use of the tube for enteral feeds (done to remove gastric products)
	- if placed for <u>SBO</u> → low intermittent wall suction should be started early and continued as needed
...
- if patient has no concerning findings at this time and output not tremendously high, begin **2h sterile water trial** (25cc bolus in first hour, 25cc bolus in second hour) — watch for signs of peritoneal irritation or leakage
...
- <u>follow-up</u>: typically at **3-4 weeks**
	- T-fasteners fall off after 2-3 weeks — residual parts removed if they haven't dislodge completely
